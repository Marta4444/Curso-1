CREATE DATABASE DBJardineria CHARACTER SET utf8 COLLATE utf8_spanish_ci;
...
CREATE TABLE Empleados (
  ...
  CONSTRAINT emp_ofi_fk FOREIGN KEY (CodigoOficina) REFERENCES Oficinas (CodigoOficina),
  CONSTRAINT emp_jef_fk FOREIGN KEY (CodigoJefe) REFERENCES Empleados (CodigoEmpleado)
);
...
CREATE TABLE Clientes (
  ...
  CONSTRAINT cli_rep_fk FOREIGN KEY (CodigoEmpleadoRepVentas) REFERENCES Empleados (CodigoEmpleado)
);
...
CREATE TABLE Pedidos (
  ...
  CONSTRAINT ped_cli_fk FOREIGN KEY (CodigoCliente) REFERENCES Clientes (CodigoCliente)
);
...
CREATE TABLE Productos (
  ...
  CONSTRAINT pro_gam_fk FOREIGN KEY (Gama) REFERENCES GamasProductos (Gama)
);
...
CREATE TABLE DetallePedidos (
  ...
  CONSTRAINT det_ped_fk FOREIGN KEY (CodigoPedido) REFERENCES Pedidos (CodigoPedido),
  CONSTRAINT det_pro_fk FOREIGN KEY (CodigoProducto) REFERENCES Productos (CodigoProducto)
);
...
CREATE TABLE Pagos (
  ...
  CONSTRAINT pag_cli_fk FOREIGN KEY (CodigoCliente) REFERENCES Clientes (CodigoCliente)
);
